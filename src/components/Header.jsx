...
export default function Header() {
  ...
  return (
    <header className="fixed top-3 left-3 right-3 lg:top-4 lg:left-6 lg:right-6 z-50">
      <div
        className={`rounded-full transition-all duration-300 ${
          scrolled
            ? 'bg-sana-gray-900/95 backdrop-blur-md py-2 shadow-2xl shadow-black/30'
            : 'bg-sana-gray-900 py-3 shadow-xl shadow-black/20'
        }`}
      >
        <div className="px-6 lg:px-8 flex items-center justify-between gap-4">
          {/* Logo */}
              ...
              >
                ...
                {link.submenu && openDropdown === link.to && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2">
                    <div className="bg-sana-gray-900 border border-sana-gray-800 rounded-2xl py-2 min-w-[180px] shadow-xl animate-fade-in">
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="xl:hidden bg-sana-gray-900 border-t border-sana-gray-800 animate-fade-in max-h-[80vh] overflow-y-auto rounded-b-3xl">
