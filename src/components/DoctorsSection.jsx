    ...
    <section className="section-padding bg-sana-cream">
      <div className="container-x">
        ...
        <div className="text-center mb-10 md:mb-16 max-w-2xl mx-auto">
          <div className="eyebrow mb-4">Echipa noastră</div>
          <h2 className="text-4xl lg:text-5xl text-sana-gray-900 mb-6 leading-tight">
            Specialiștii care au grijă de zâmbetul tău
          </h2>
          <p className="text-sana-gray-600 leading-relaxed text-sm md:text-base">
            O echipă dedicată, formată din medici cu experiență, pasionați de excelență în stomatologie.
          </p>
        </div>

        {/* CONTAINERUL PRINCIPAL */}
        <div className="flex flex-row lg:grid lg:grid-cols-[280px_1fr] gap-2 md:gap-8 lg:gap-12 items-start">
          
          {/* COLOANA STÂNGA (Lista/Sidebar):
            - Înlocuit fundalul alb cu gri-ul închis de brand (bg-sana-gray-900 sau clasa corespunzătoare culorii tale de footer)
            - Adăugat o umbră custom extrem de pronunțată și moale (soft glow effect)
          */}
          <div 
                  ...
                  <li key={cat.id}>
                    <button
                      ...
                      className={`w-full text-left px-2 py-3 md:px-5 md:py-4 rounded-xl md:rounded-2xl transition-all duration-300 flex items-center justify-between group ${
                        isActive
                          ? 'bg-sana-lime text-sana-gray-900 font-semibold shadow-[0_4px_15px_rgba(214,255,0,0.15)]' // Highlight activ pe fundalul gri
                          : hasDoctors
                          ? 'text-white/80 hover:bg-white/10 hover:text-white' // Culori text pentru butoanele inactive pe fundal închis
          ...
          {/* Coloana Dreaptă (Lista de doctori) */}
          <div className="w-[65%] lg:w-auto space-y-3 md:space-y-5 min-h-[300px] md:min-h-[400px]">
